...
- (void)viewDidLoad {
    ...
    [self.secondBold
        setFont:[UIFont fontWithName:@"OpenSans-Semibold" size:17]];
    ...
    [self.secondRegular
        setFont:[UIFont fontWithName:@"OpenSans-Light" size:14]];
    [self.thirdRegular setFont:[UIFont fontWithName:@"OpenSans-Light" size:14]];
    [self.fourthRegular
        setFont:[UIFont fontWithName:@"OpenSans-Light" size:14]];
    [self.okButton.titleLabel
        setFont:[UIFont fontWithName:@"OpenSans" size:18]];
...
- (void)beginAnimations {
    ...
    CGAffineTransform firstTranslation =
        CGAffineTransformTranslate(self.firstView.transform, 20, 0);
    CGAffineTransform secondTranslation =
        CGAffineTransformTranslate(self.secondView.transform, 20, 0);
    CGAffineTransform thirdTranslation =
        CGAffineTransformTranslate(self.thirdView.transform, 20, 0);
    CGAffineTransform fourthTranslation =
        CGAffineTransformTranslate(self.fourthView.transform, 20, 0);
...
- (IBAction)clickedContinue:(UIButton *)sender {
    ...
    [UIView animateKeyframesWithDuration:0.2
        delay:0
        options:0
        animations:^{ sender.transform = translation; }
        completion:^(BOOL finished) {}];
